    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profileImgae', django_resized.forms.ResizedImageField(crop=None, force_format=None, keep_meta=True, quality=90, scale=None, size=[200, 200], upload_to='profile_images')),
